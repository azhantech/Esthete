    ...
    const renderItem = ({ item }: any) => (
        <TouchableOpacity activeOpacity={0.7} style={styles.itemContainer}>
            ...
            <View style={styles.row}>
                <CustomText style={styles.dateTime}>Date: <CustomText style={styles.blackText}>{item.date}</CustomText></CustomText>
                <CustomText style={styles.dateTime}>Time: <CustomText style={styles.blackText}>{item.time}</CustomText></CustomText>
            </View>
            <TouchableOpacity activeOpacity={0.7} style={styles.markButton}>
                <CustomText style={styles.markText}>Mark Read</CustomText>
            </TouchableOpacity>
        </TouchableOpacity>
    )
    ...
    return (
        <ScreenWrapper mainContainerStyles={styles.container}>
            ...
            <FlatList
                ...
                ListFooterComponent={<TouchableOpacity activeOpacity={0.7} style={styles.viewAllBtn}>
                    <CustomText weight="semiBold" style={styles.markText}>View All</CustomText>
                </TouchableOpacity>}
