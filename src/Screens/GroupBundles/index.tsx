    ...
    const renderPackage = ({ item }) => (
        <View style={styles.packageContainer}>
            <View style={{ width: '100%', }}>
                ...
                {item.id > 1 && <CustomText style={styles.priceInfo}>{'Save 20%'}</CustomText>}
            </View>

            <Input
                label='Includes'
                placeholder='Access To 1 Paid Group'
            />
            ...
            <View style={styles.dotsContainer}>
                {packages.map((_, index) => (
                    <View
                        ...
                        style={[
                            styles.dot,
                            currentPackageIndex === index ? styles.activeDot : styles.inactiveDot,
                        ]}
                    />
                ))}
            </View>
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headingContainer}>
                <CustomText weight='bold' style={styles.header}>Group Bundles</CustomText>
                <CustomText weight='bold' style={styles.subHeader}>{packages[currentPackageIndex].name}</CustomText>
            </View>
            ...
            <Button text={'Purchase Bundle'} onPress={purchaseBundle} style={styles.mainBtn} />
